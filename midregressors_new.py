...
def usage():
    print("usage: midregressors inputfile outputroot")
    print("")
...
for i in range(0,numtrials):
    ...
    target_time = (Target_OnsetTime[i]-GetReadyDummy_OffsetTime[i])/1000.0
    ...
    thetime = (WarningStim_OnsetTime[i]-GetReadyDummy_OffsetTime[i])/1000.0
    ...
    if (Incentive[i] == '+$') and (FixationITI_OnsetTime[i]-RewFeedback_OffsetTime[i]<1300):
        thetime = (RewFeedback_OnsetTime[i]-GetReadyDummy_OffsetTime[i])/1000.0
    ...
    if (Incentive[i] == '+$') and (FixationITI_OnsetTime[i]-FeedbackNoChangeOnREW_OffsetTime[i]<1300.0):
        thetime = (FeedbackNoChangeOnREW_OnsetTime[i]-GetReadyDummy_OffsetTime[i])/1000.0
    ...
    if (Incentive[i] == '-$') and (FixationITI_OnsetTime[i]-PenFeedback_OffsetTime[i]<1300):
        thetime = (PenFeedback_OnsetTime[i]-GetReadyDummy_OffsetTime[i])/1000.0
    ...
    if (Incentive[i] == '-$') and (FixationITI_OnsetTime[i]-FeedbackNoChangeOnPEN_OffsetTime[i]<1300.0):
        thetime = (FeedbackNoChangeOnPEN_OnsetTime[i]-GetReadyDummy_OffsetTime[i])/1000.0
    ...
    if (Incentive[i] == '0$') and (FixationITI_OnsetTime[i]-FeedbackNCneutralFast_OffsetTime[i]<1300.0):
        thetime = (FeedbackNCneutralFast_OnsetTime[i]-GetReadyDummy_OffsetTime[i])/1000.0
    ...
    if (Incentive[i] == '0$') and (FixationITI_OnsetTime[i]-FeedbackNCneutralSlow_OffsetTime[i]<1300.0):
        thetime = (FeedbackNCneutralSlow_OnsetTime[i]-GetReadyDummy_OffsetTime[i])/1000.0
